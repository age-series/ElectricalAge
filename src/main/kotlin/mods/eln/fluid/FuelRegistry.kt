...
object FuelRegistry {
    ...
    private val dieselDefaults = listOf(
        ...
        fuel("nitroglycerin", 11600000.0, 0.70, 0.70, "HBM Nuclear Tech, nitroglycerin, density approximately 1.60 kg/L, controlled combustion LHV approximately 7.27 MJ/kg, about 11.6 MJ/L (Meyer, Explosives). Treated as a controlled-burn fuel; high temperature, NOx-heavy exhaust."),
        ...
        fuel("coaloil", 35400000.0, 0.5, 0.30, "HBM Nuclear Tech, coal oil (coal-derived middle distillate), density approximately 0.95 kg/L, LHV approximately 37.3 MJ/kg (Perry's Chemical Engineers' Handbook). Sulfur-bearing, moderate soot."),
        ...
        fuel("smear", 35800000.0, 0.5, 0.40, "HBM Nuclear Tech, industrial oil (smear), density approximately 0.88 kg/L, LHV approximately 40.7 MJ/kg (modeled on used heavy industrial oil per Engineering Toolbox). Contaminated waste stream, high wear."),
    ...
    private val gasolineDefaults = listOf(
        fuel("chloromethane", 13400000.0, 0.40, 0.85, "HBM Nuclear Tech, chloromethane (stored as liquefied gas), density approximately 0.911 kg/L, LHV approximately 14.7 MJ/kg, about 13.4 MJ/L (NIST WebBook). Combustion releases HCl, severely corrosive to turbine blades."),
        fuel("methanol", 15760000.0, 0.40, 0.05, "HBM Nuclear Tech, methanol, density 0.792 kg/L, LHV 19.9 MJ/kg, about 15.76 MJ/L (NIST). Clean-burning oxygenate, similar profile to ethanol."),
        fuel("bloodgas", 16000000.0, 0.40, 0.60, "HBM Nuclear Tech, blood fuel, density approximately 1.06 kg/L, treated as a low-grade biological fuel with LHV approximately 15 MJ/kg. Organic contaminants and residual proteins produce heavy fouling."),
        fuel("vinyl", 17170000.0, 0.45, 0.90, "HBM Nuclear Tech, vinyl chloride (liquefied), density approximately 0.911 kg/L, LHV approximately 18.85 MJ/kg, about 17.17 MJ/L (Engineering Toolbox). Combustion releases HCl, extreme corrosion."),
        ...
        fuel("hydrazine", 19810000.0, 0.60, 0.10, "HBM Nuclear Tech, hydrazine, density 1.021 kg/L, LHV 19.4 MJ/kg, about 19.81 MJ/L (NIST). Bipropellant combustion value; products are mainly N2 and H2O, very clean."),
        fuel("chloroethane", 20240000.0, 0.45, 0.80, "HBM Nuclear Tech, chloroethane (liquefied), density approximately 0.92 kg/L, LHV approximately 22 MJ/kg, about 20.24 MJ/L (NIST WebBook). Combustion releases HCl, severe turbine corrosion."),
        ...
        fuel("dicyanoacetylene", 25000000.0, 0.95, 0.40, "HBM Nuclear Tech, dicyanoacetylene (C4N2), density approximately 0.907 kg/L, full combustion LHV approximately 27.7 MJ/kg, about 25 MJ/L (NIST thermochemistry). Burns at approximately 5260 K in O2 (Kirshenbaum and Grosse, J. Am. Chem. Soc.), the hottest known chemical flame; large NOx production."),
        ...
        fuel("dhc", 34000000.0, 0.55, 0.20, "HBM Nuclear Tech, deuterated hydrocarbon, density approximately 0.85 kg/L, LHV approximately 40 MJ/kg estimated from regular hydrocarbon LHV with isotope adjustment, about 34 MJ/L. Chemistry identical to standard hydrocarbons."),
        ...
        fuel("xylene", 35000000.0, 0.55, 0.20, "HBM Nuclear Tech, BTX (benzene-toluene-xylene cut), density approximately 0.87 kg/L, LHV approximately 40.2 MJ/kg, about 35 MJ/L (Engineering Toolbox). Aromatic, sooty exhaust."),
        ...
        fuel("nitan", 36000000.0, 0.65, 0.05, "HBM Nuclear Tech, NITAN 100 Octane Super Fuel, fictional premium gasoline analogue, estimated LHV approximately 48 MJ/kg, about 36 MJ/L at approximately 0.75 kg/L (extrapolated from premium aviation gasoline references)."),
        fuel("nmass", 38000000.0, 0.70, 0.10, "HBM Nuclear Tech, N-MASS(II) Driver Fuel, fictional high-performance synthetic fuel, estimated LHV approximately 38 MJ/L (modeled on energetic synthetic propellants such as nitroalkanes with oxidizer enrichment)."),
        fuel("highgradekerosene", 39200000.0, 0.60, 0.05, "ContentTweaker refined kerosene, LHV 39.2 MJ/L."),
        fuel("nmasstetranol", 42000000.0, 0.80, 0.10, "HBM Nuclear Tech, N-MASS(III) Tetrahexaethanol, fictional advanced synthetic fuel, estimated LHV approximately 42 MJ/L (extrapolated from N-MASS(II) progression)."),
        fuel("balefire", 50000000.0, 0.85, 0.80, "HBM Nuclear Tech, BF Rocket Fuel (balefire), fictional sci-fi propellant, estimated LHV approximately 50 MJ/L (well above conventional hydrocarbons but bounded by combined-propellant theoretical limits). Radiologically contaminated exhaust drives heavy turbine wear.")
    )
    ...
    private val gasDefaults = listOf(
        ...
        fuel("superheated_hydrogen", 10800.0 * 1000, 0.40, 0.0, "HBM Nuclear Tech superheated hydrogen, same chemical LHV as hydrogen (about 10.8 MJ/m^3) but elevated inlet enthalpy raises turbine temperature factor. Stored with the ELN gas pressurization multiplier applied."),
        fuel("ammonia", 14000.0 * 1000, 0.40, 0.20, "HBM Nuclear Tech ammonia, density approximately 0.76 kg/m^3 at STP, LHV 18.6 MJ/kg, about 14.1 MJ/m^3 (NIST). Combustion produces NOx but no soot. Stored with the ELN gas pressurization multiplier applied."),
