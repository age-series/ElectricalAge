...
class PowerSourceElement(sixNode: SixNode, side: Direction, descriptor: SixNodeDescriptor) : SixNodeElement(sixNode, side, descriptor), IConfigurable {
...
class PowerSourceGui(var render: PowerSourceRender) : GuiScreenEln() {
