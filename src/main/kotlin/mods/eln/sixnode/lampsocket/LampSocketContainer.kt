...
class LampSocketContainer(player: EntityPlayer, inventory: IInventory) : BasicContainer(player, inventory, arrayOf(
        LampSlot(inventory, LAMP_SLOT_ID, 70+0, 57, 1, ACCEPTED_LAMP_TECHNOLOGY),
    ...
    companion object {
        ...
        @JvmField
        val ACCEPTED_LAMP_TECHNOLOGY = arrayOf(
            LampDescriptor.Technology.INCANDESCENT, LampDescriptor.Technology.FLUORESCENT,
            LampDescriptor.Technology.INFRARED, LampDescriptor.Technology.LED
        )
    }
