...
import mods.eln.item.LampData
import mods.eln.item.LampDescriptor
import mods.eln.misc.Utils.getItemObject
import net.minecraft.inventory.IInventory
import net.minecraft.item.ItemStack

class LampSlot(inventory: IInventory, slot: Int, x: Int, y: Int, stackLimit: Int, val acceptedLampTypes: Array<LampData>) :
    ...
    override fun isItemValid(itemStack: ItemStack): Boolean {
        ...
        else (getItemObject(itemStack) as LampDescriptor?)?.lampData in acceptedLampTypes
    }
