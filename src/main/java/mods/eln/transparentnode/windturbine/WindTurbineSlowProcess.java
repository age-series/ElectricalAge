    ...
    public void process(double time) {
        ...
        if (environmentTimeCounter < 0.0) {
            ...
            if (!notInCache) {
                ...
                DP.println(DPType.TRANSPARENT_NODE, "EnvironementWindFactor : " + environmentWindFactor);
            }
        }
        ...
        counter++;
        if (counter % 20 == 0) {
            DP.println(DPType.TRANSPARENT_NODE, "Wind : " + getWind() + "  Derivate : " + localWindDerive + " EPmax : " + P);
        }
    }
