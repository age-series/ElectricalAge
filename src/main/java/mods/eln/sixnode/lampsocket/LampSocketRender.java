...
public class LampSocketRender extends SixNodeElementRender {
    ...
    void setLight(byte newLight) {
        light = newLight;
        if (lampDescriptor != null && lampDescriptor.getLampData().getTechnology().getLampType().equals("fluorescent") && oldLight != -1 && oldLight < 9 && light >= 9) {
    ...
    public void publishUnserialize(DataInputStream stream) {
        ...
        try {
            ...
            if (itemStack != null ) {
                ...
                if (cable == null) cable = (CurrentCableDescriptor) CurrentCableDescriptor.getDescriptor(itemStack, CurrentCableDescriptor.class);
            } else {
                cable = null;
            }
