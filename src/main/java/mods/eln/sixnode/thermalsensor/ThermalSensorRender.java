	...
	*/
    ...
    public void publishUnserialize(DataInputStream stream) {
        ...
        try {
            ...
            typeOfSensor = b & 0x3;
            lowValue = (float) (stream.readFloat() + ThermalConstants.AMBIENT_TEMPERATURE_CELSIUS);
            highValue = (float) (stream.readFloat() + ThermalConstants.AMBIENT_TEMPERATURE_CELSIUS);
