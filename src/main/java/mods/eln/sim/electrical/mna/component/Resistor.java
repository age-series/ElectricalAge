...
/*	public Line line = null;
    ...
    private double r = ElectricalConstants.HIGH_IMPEDANCE, rInv = 1 / ElectricalConstants.HIGH_IMPEDANCE;
    ...
    public Resistor setR(double r) {
        if (Double.isNaN(r) || Double.isInfinite(r) || r > ElectricalConstants.ULTRA_IMPEDANCE || r < ElectricalConstants.NO_IMPEDANCE) {
    ...
    public void highImpedance() {
        setR(ElectricalConstants.HIGH_IMPEDANCE);
    }

    public void ultraImpedance() {
        setR(ElectricalConstants.ULTRA_IMPEDANCE);
    }

    public Resistor pullDown() {
        setR(ElectricalConstants.PULL_DOWN_RESISTANCE);
        return this;
    }
