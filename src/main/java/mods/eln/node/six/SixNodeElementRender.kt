...
abstract class SixNodeElementRender(@JvmField open var tileEntity: SixNodeEntity, @JvmField var side: Direction, @JvmField open var sixNodeDescriptor: SixNodeDescriptor) {
    @JvmField
