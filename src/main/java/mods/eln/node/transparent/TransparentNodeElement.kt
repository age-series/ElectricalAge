...
abstract class TransparentNodeElement(@JvmField open var node: TransparentNode?, @JvmField open var transparentNodeDescriptor: TransparentNodeDescriptor) : GhostObserver, IPlayer, INodeElement {
    @JvmField
