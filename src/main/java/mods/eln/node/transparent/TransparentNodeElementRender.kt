...
abstract class TransparentNodeElementRender(@JvmField open var tileEntity: TransparentNodeEntity, @JvmField open var transparentNodedescriptor: TransparentNodeDescriptor) {
    @JvmField
