...
- **Svein Ove Aas (Baughn)** – code, some 3D models, concepts
...
- **TheBroBeans** – initial promoter
- **don_bruce / BenPlotz** – forum expert, [video tutorials](https://www.youtube.com/channel/UCRYhOQhspQqIBvL8kiDu2Rw)
- **Baughn** – forum expert
- ...

For an automatically generated list of contributors, see the [GitHub contributors graph](https://github.com/age-series/ElectricalAge/graphs/contributors).
